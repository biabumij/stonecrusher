				...
				<th class="text-right">
					<table width="100%" border="0" cellpadding="0">
						<tr>
								...
								<th class="text-right" width="90%">
									<span><a target="_blank" href="<?= base_url("laporan/cetak_beban_pokok_penjualan?filter_date=".$filter_date = date('d F Y',strtotime($arr_filter_date[0])).' - '.date('d F Y',strtotime($arr_filter_date[1]))) ?>"><?php echo number_format(0,0,',','.');?></a></span>
								</th>
							</tr>
					</table>
				</th>
				<th class="text-right">
					<table width="100%" border="0" cellpadding="0">
						<tr>
								...
								<th class="text-right" width="90%">
									<span><?php echo number_format($nilai_rap_2,0,',','.');?></span>
								</th>
							</tr>
					</table>
				</th>
