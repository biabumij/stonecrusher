                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="panel">
                            <div class="panel-header">
                                <div class="">
                                    <h4 class="">Surat Jalan Pengiriman Penjualan (Retur)</h4>
                                </div>
                            </div>
                            <div class="panel-content">
                            <form id="form-pro" method="POST" class="form-pro" action="<?php echo site_url('pmm/productions/process_retur'); ?>" enctype="multipart/form-data" onsubmit="setTimeout(function () { window.location.reload(); }, 1000)">
                                <table class="table">
                                        <tr>
                                ...
                                <div id="alert-receipt-material-total-retur" class="row"></div>
                                    ...
                                    <div class="row">
										<div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <label for="inputEmail3" class="control-label">Konversi (Isi angka "1" Jika tidak ada konversi)<span class="required" aria-required="true">*</span></label>
                                ...
                                <div class="text-right">
                                    <button class="btn btn-danger" id="btn-view" style="width:100px; font-weight:bold; border-radius:10px;"><i class="fa fa-search"></i> Lihat Data</button>
                                </div>
