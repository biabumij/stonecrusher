                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <?php if($detail["status"] === "UNPAID") : ?>
                                            <a href="<?= base_url("pmm/Jurnal_umum/approvalJurnal/".$detail["id"]) ?>" class="btn btn-success" style="width:10%; font-weight:bold; border-radius:10px;"><i class="fa fa-check"></i> Approve</a>
                                            <a href="<?= base_url("pmm/Jurnal_umum/rejectedJurnal/".$detail["id"]) ?>"class="btn btn-primary" style="width:10%; font-weight:bold; border-radius:10px;"><i class="fa fa-close"></i> Reject</a>
                                        <?php endif; ?>
                                        <?php
                                        }
                                        ?>
