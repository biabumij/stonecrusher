	...
	<br />
		...
		<?php
			...
			<tr class="table-active3">
				...
				<th align="right"><?php echo number_format($total_nilai_produksi_boulder / round($total_rekapitulasi_produksi_harian,2),0,',','.');?></th>
			...
			<tr class="table-active3">
				...
				<th align="right"><?php echo number_format($total_rekapitulasi_produksi_harian,2,',','.');?></th>
				<th align="right"><?php echo number_format((($nilai_tangki_ton + $nilai_sc_ton + $nilai_gns_ton + $nilai_wl_ton + $nilai_timbangan_ton + $nilai_bbm_solar_ton) * round($total_rekapitulasi_produksi_harian,2)) / $total_rekapitulasi_produksi_harian ,0,',','.');?></th>
				...
				<th align="right"><?php echo number_format($total_rekapitulasi_produksi_harian,0,',','.');?></th>
				<th align="right"><?php echo number_format(($total_biaya_peralatan + $total_nilai_produksi_solar) / round($total_rekapitulasi_produksi_harian,2),0,',','.');?></th>
				...
				?>
				<th align="right"><?php echo number_format($total_rekapitulasi_produksi_harian,0,',','.');?></th>
				<th align="right"><?php echo number_format($nilai_evaluasi_alat / round($total_rekapitulasi_produksi_harian,2),0,',','.');?></th>
			...
			<tr class="table-active3">
				...
				<th align="right"><?php echo number_format($total_rekapitulasi_produksi_harian,2,',','.');?></th>
				<th align="right"><?php echo number_format(($overhead_ton * round($total_rekapitulasi_produksi_harian,2)) / round($total_rekapitulasi_produksi_harian,2),0,',','.');?></th>
				<th align="right"><?php echo number_format($overhead_ton * round($total_rekapitulasi_produksi_harian,2),0,',','.');?></th>
				<th align="right"><?php echo number_format($total_rekapitulasi_produksi_harian,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_operasional / round($total_rekapitulasi_produksi_harian,2),0,',','.');?></th>
				...
				?>
				<th align="right"><?php echo number_format($total_rekapitulasi_produksi_harian,0,',','.');?></th>
				<th align="right"><?php echo number_format($nilai_evaluasi_overhead / round($total_rekapitulasi_produksi_harian,2),0,',','.');?></th>
