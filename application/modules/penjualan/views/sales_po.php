                            ...
                            <div class="panel-content">
                                <form method="POST" action="<?php echo site_url('penjualan/submit_sales_po');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="text-center">
                                        <a href="<?php echo site_url('admin/penjualan');?>" class="btn btn-danger" style="margin-bottom:0px; width:100px; font-weight:bold; border-radius:10px;"><i class="fa fa-close"></i> Batal</a>
