                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="panel">
                            ...
                            <div class="panel-content">
                                <form method="POST" action="<?php echo site_url('penjualan/submit_uang_muka');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
                                    <input type="hidden" name="sales_po_id" value="<?= $row["id"] ?>">
