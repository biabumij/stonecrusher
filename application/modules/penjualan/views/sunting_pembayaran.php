                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="panel">
                            <div class="panel-header"> 
                                <div class="">
                                    <h3 class="">Edit Penerimaan Penjualan</h3>
                                </div>
                            </div>
                            <div class="panel-content">
                                <form method="POST" action="<?php echo site_url('penjualan/simpan_pembayaran'); ?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
                                        ...
                                        <table class="table table-bordered table-striped table-condensed">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="25%" class="text-center">Pembayaran saat ini</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                    ...
                                    <div class="text-center">
                                        <a href="<?= site_url('penjualan/detailPenagihan/'.$bayar["penagihan_id"]);?>" class="btn btn-danger" style="margin-bottom:0px; width:100px; font-weight:bold; border-radius:10px;"><i class="fa fa-close"></i> Batal</a>
