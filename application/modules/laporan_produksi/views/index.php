                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.data) {
                            ...
                            if (result.data.length > 0) {
                                $.each(result.data, function(i, val) {
                                    $('#table-date8b tbody').append('<tr onclick="NextShowRekapitulasiLaporanProduksi(' + val.no + ')" class="active" style="font-weight:bold;cursor:pointer;"><td class="text-center">' + 1 + '</td><td class="text-left">' + val.produk_a + '</td><td class="text-right">' + val.measure_a + '</td><td class="text-right">' + val.presentase_a + ' %</td><td class="text-right">' + val.jumlah_pemakaian_a + '</td></tr><tr onclick="NextShowLaporanProduksi(' + val.no + ')" class="active" style="font-weight:bold;cursor:pointer;"><td class="text-center">' + 2 + '</td><td class="text-left">' + val.produk_b + '</td><td class="text-right">' + val.measure_b + '</td><td class="text-right">' + val.presentase_b + ' %</td><td class="text-right">' + val.jumlah_pemakaian_b + '</td></tr><tr onclick="NextShowLaporanProduksi(' + val.no + ')" class="active" style="font-weight:bold;cursor:pointer;"><td class="text-center">' + 3 + '</td><td class="text-left">' + val.produk_c + '</td><td class="text-right">' + val.measure_c + '</td><td class="text-right">' + val.presentase_c + ' %</td><td class="text-right">' + val.jumlah_pemakaian_c + '</td></tr><tr onclick="NextShowLaporanProduksi(' + val.no + ')" class="active" style="font-weight:bold;cursor:pointer;"><td class="text-center">' + 4 + '</td><td class="text-left">' + val.produk_d + '</td><td class="text-right">' + val.measure_d + '</td><td class="text-right">' + val.presentase_d + ' %</td><td class="text-right">' + val.jumlah_pemakaian_d + '</td><tr onclick="NextShowLaporanProduksi(' + val.no + ')" class="active" style="font-weight:bold;cursor:pointer;"><td class="text-center">' + 5 + '</td><td class="text-left">' + val.produk_e + '</td><td class="text-right">' + val.measure_e + '</td><td class="text-right">' + val.presentase_e + ' %</td><td class="text-right">' + val.jumlah_pemakaian_e + '</td></tr><tr onclick="NextShowLaporanProduksi(' + val.no + ')" class="active" style="font-weight:bold;cursor:pointer;"><td class="text-center">' + 6 + '</td><td class="text-left">' + val.produk_f + '</td><td class="text-right">' + val.measure_f + '</td><td class="text-right">' + val.presentase_f + ' %</td><td class="text-right">' + val.jumlah_pemakaian_f + '</td></tr><tr onclick="NextShowLaporanProduksi(' + val.no + ')" class="active" style="font-weight:bold;cursor:pointer;"><td class="text-center" colspan="2">' + 'TOTAL' + '</td><td class="text-right">' + val.measure_a + '</td><td class="text-right">' + val.jumlah_presentase + ' %</td><td class="text-right">' + result.total + '</td></tr>');                                
                                });
                            } else {
