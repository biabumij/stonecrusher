                                ...
                                <div class="text-center">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            ...
                                            <button type="submit" class="btn btn-danger" style="width:200px; font-weight:bold; border-radius:10px; border-bottom:0px;"><i class="fa fa-briefcase"></i> Closed</button>     
                                            </form>
                                            <form class="form-check" action="<?= base_url("pembelian/reject_penawaran_pembelian/".$row["id"]) ?>">
                                    ...
                                    <?php if($row["status"] === "CLOSED") : ?>
                                        ...
                                        ?>
                                            <form class="form-check" action="<?= base_url("pembelian/open_penawaran_pembelian/".$row["id"]) ?>">
                                                <button type="submit" class="btn btn-success" style="width:200px; font-weight:bold; border-radius:10px;"><i class="fa fa-folder-open-o"></i> Open</button>        
                                            </form>	
                                        <?php
                                        }
                                        ?>
                                        ...
                                        ?>
                                            <form class="form-check" action="<?= base_url("pembelian/hapus_penawaran_pembelian/".$row["id"]) ?>">
                                                <button type="submit" class="btn btn-danger" style="width:200px; font-weight:bold; border-radius:10px;"><i class="fa fa-trash"></i> Hapus</button>
                                            </form>
                                        <?php
                                        }
                                        ?>
